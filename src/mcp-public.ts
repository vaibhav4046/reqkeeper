...
import { findPaymentByReference, verdictFor, type PaymentExpectation, type PaymentVerdict } from "./chain.ts";
 ...
 */
function caveatFor(verdict: PaymentVerdict, corroboratedBy: string | null): string | null {
  switch (verdict.kind) {
    case "PAID":
